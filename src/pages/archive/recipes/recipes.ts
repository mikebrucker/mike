...
export const recipes: Dictionary<IRecipe> = {
	...
	"buffalo-chicken-cheesesteak-stromboli": {
		...
		steps: [
			{
				step: [
					"make dough", "roll dough",
				]
			},
			{
				step: [
					"cut chicken", "cook chicken", "hot sauce chicken",
				]
			},
			{
				step: [
					"put mozz on dough", "put chicken on mozz", "put blue cheese on chicken", "put more mozz", "wrap", "seal with some more mozz"
				]
			},
			{
				step: [
					"put in oven for 14 minutes at 200-220", "take out", "cut and eat with blue cheese side"
				]
			},
		]
	},
